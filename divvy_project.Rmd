...
```{r}
wrigley_df <- result_df %>% filter((start_lat <= 41.95 & start_lat >= 41.94 & start_lng <= -87.65 & start_lng >= -87.66 )|(end_lat <= 41.95 & end_lat >= 41.94 & end_lng <= -87.65 & end_lng >= -87.66) ) %>% mutate(start_date = as.Date(started_at)) %>% mutate(gameday = ifelse(start_date %in% wrigley_dates, 1, 0))
